...
def send_now(missing):
    ...
    sender = 'Nexus Vlan Audit <no_reply@ipdevops.com>'
    receivers = ['osama@ipdevops.com']
    msg = EmailMessage()
    


    if missing is True:
        msg_body = """ Nexus audit report is ready and missing vlans were discovered, Find that attached report!"""
